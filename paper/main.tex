...
Public Virtual Metrology, Physics, Coupling, Early Warning, and Attribution}
...
availability. Controller efficacy and safety-filter outcomes remain
unavailable. No
...
not experimental causal proof or permission to act.
\end{abstract}
...
with mandatory abstention. Predictive control, safety filtering, and the
integrated comparison remain protocols until their acceptance evidence exists.
...
\begin{table*}[t]
\centering
\caption{Manuscript evidence status at the WP09/WP12/WP13 freeze. ``Protocol'' means the
...
complete. Supported conclusions remain limited to the retained PHM roles and
to the tested synthetic equations, declared topology, and named WP12/WP13
ensembles.
